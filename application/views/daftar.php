                ...
                <div class="mdc-card" style="border-radius: 1%;">
                  <?php if (isset($_GET['pesan']) && $_GET['pesan'] == "error") { ?>
                    <div class="alert" style="border:1px solid #00aeed;background-color:#ed0000;text-align: center;height:80px; border-radius: 25px;  display: flex;align-items: center;">
                      <label style="vertical-align:middle;color:yellow; float: left; margin:0 auto;"><strong>Daftar Gagal..!</strong><br> Mohon untuk melengkapi data dengan benar</label>
                    </div>
                  <?php } else { ?>
                    <div class="alert" style="border:1px solid #00aeed;background-color:#00aeed;text-align: center;height:80px; border-radius: 25px;  display: flex;align-items: center;">
                      <label style="vertical-align:middle;color:white; float: left; margin:0 auto;">
                        <h3>Sign Up</h3>
                      </label>
                    </div>
                  <?php } ?>
                  <form action="<?= base_url() ?>member/signup" method="post">
                    <div class="mdc-layout-grid">
                      <div class="mdc-layout-grid__inner">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                            ...
                            <div class="mdc-line-ripple"></div>
                            <label for="text-field-hero-input" class="mdc-floating-label">Nama Lengkap</label>
                          </div>
                        </div>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input" id="text-field-hero-input" type="number" name="no_telp">
                            <div class="mdc-line-ripple"></div>
                            <label for="text-field-hero-input" class="mdc-floating-label">No Handphone</label>
                          </div>
                        </div>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input" type="password" id="text-field-hero-input" name="conf_password">
                            <div class="mdc-line-ripple"></div>
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
                          <div style="text-align: center;vertical-align:middle">
                            <label style="vertical-align:middle;color:#00aeed; float: left; margin:0 auto;">Sudah punya akun? Masuk disini</label>
                          </div>
                        </div>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6">
