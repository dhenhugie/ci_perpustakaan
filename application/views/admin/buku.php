...
<div class="body-wrapper">
    ...
    <div class="main-wrapper mdc-drawer-app-content">
        ...
        <div class="page-wrapper mdc-toolbar-fixed-adjust">
                                            ...
                                            foreach ($buku as $key) { ?>
                                                <tr>
                                                    ...
                                                    <td nowrap="nowrap">
                                                        ...
                                                        <button class="btn btn-danger" id="deleteBtn" onclick="hapus('<?= $key->id_buku; ?>', '<?= $key->gambar; ?>')">
            ...
            <script>
                function hapus(idBuku, idGambar) {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            url = '<?= base_url() ?>admin/hapus_buku/' + idBuku + '/' + idGambar;
                            console.log(url);
                            $.ajax({
                                url: url,
                                error: function() {
                                ...
                                success: function() {
                                    Swal.fire("Berhasil!", "Buku telah dhapus!", "success");
                                    setTimeout(function() {
