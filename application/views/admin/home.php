                ...
                <div class="pl-3 pr-3">
                  <div class="table-responsive">
                    <?php if ($jmltransaksi > 0) { ?>
                      <table class="table table-hoverable">
                        ...
                        <tbody>
                          ...
                          foreach ($transaksi as $key) { ?>
                            <tr>
                              <td class="text-left"><?= date('d/m/Y', strtotime($key->tanggal_pinjam)) ?></td>
                              <td><?= $key->nama_anggota ?></td>
                              <td><?= $key->judul_buku ?></td>
                              <td><?php if (empty($key->status_peminjaman)) {
                      ...
                      <div><button class="btn btn-primary" onclick="window.location='<?= base_url('admin/transaksi') ?>'">Lihat semua transaksi</button></div>
                    <?php } else { ?>
                      <div class="d-flex justify-content-center">
                        <div class="d-flex align-items-center">Tidak ada transaksi baru-baru ini...</div>
                      </div>
                    <?php } ?>
                  </div>
                </div>
